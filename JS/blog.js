const url = "https://hjulbent.no/project-exam/wp-json/wp/v2/posts?per_page=4&_embed";
...
showMore.addEventListener('click', (event) => {
    ...
    pageCounter++;
    let showMoreUrl = "https://hjulbent.no/project-exam/wp-json/wp/v2/posts?per_page=4&page=" + pageCounter + "&_embed";

    async function getMorePosts() {

        try {
            const response = await fetch(showMoreUrl);
            const results = await response.json();
            // console.log(results)
