        ...
        for (let i = 0; i < results.length; i++) {
            ...
            if (i < 4) {
                ...
                <a href="specific.html?id=${results[i].id}" class="displayed postLink">
                    <div class="carouselCard" style="background-image: url('${results[i].featured_media_src_url}')">
...
buttonNext.addEventListener('click', () => {
    ...
    } else if(carousel.style.transform === "translateX(-33.3%)") {
        carousel.style.transform = "translateX(-66.6%)";
    }
})
...
buttonPrev.addEventListener('click', () => {
    if(carousel.style.transform === "translateX(-66.6%)") {
        carousel.style.transform = "translateX(-33.3%)";
    } else if(carousel.style.transform === "translateX(-33.3%)") {
